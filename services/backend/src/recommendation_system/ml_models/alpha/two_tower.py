...
class ModelWrapper:
    ...
    def generate_user_embeddings(self, df):
        ...
        for _, row in engagement_aggregate.iterrows():
            ...
            #print(_, user_vector_dict[user_id]['millisecond_engaged_vector'][idx])
        ...
        #print(pd.DataFrame(user_vector_df['millisecond_engaged_vector'].tolist(), index=user_vector_df.index))

        #print("df in user, ", df.columns)
        #print(user_vector_df)

        #print(len(millisecond_columns))
        #print(len(user_vector_df['millisecond_engaged_vector'].tolist()[0]))
        ...
        #print("df in user, ", df)
        #print("columns df in user, ", df.columns)
