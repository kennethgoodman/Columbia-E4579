...
joblib.dump(top_artist_styles, 'top_artist_styles.pkl')
joblib.dump(top_sources, 'top_sources.pkl')
joblib.dump(top_seeds, 'top_seeds.pkl')
    ...
    def calculate_targets(self, engagement_type_vector, engagement_value_vector):
        ...
        return torch.where(
              ...
              torch.where(
                  ...
                  torch.where(
                      engagement_value_vector < 2000,
                      torch.zeros_like(engagement_type_vector), # bad engagement
                      torch.where(
                        engagement_value_vector <= 5000,
...
model_path = './two-tower-model/model_1.pt'
