...
def main(n):
	...
	for _ in tqdm(range(n)):
		...
		r = model.messages.create(model="claude-3-5-sonnet-20240620",
		    max_tokens=1024,
		    system= """Be a creative AI, this is going to be used for a recommendation system class,
		...
		commit_content(author_id, r.content[0].text, args['original_prompt'], args['prompt'], args['style'])
